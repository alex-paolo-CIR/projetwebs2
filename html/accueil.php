  ...
  <div class="contenu" id="infos">
    <div class="conteneur-complet">
      <div class="conteneur-bio">
        ...
        <div class="texte">
          <p>
            MSD est un jeune rappeur qui s'est lancé dans la musique en 2023 et n'a pas perdu de temps pour se faire
            remarquer.
            En juin 2024, il publie son premier single intitulé "Rockstar" sur SoundCloud, qui devient rapidement son
            morceau le plus streamé.
            Cet accueil encourageant marque un premier succès pour lui et le pousse à sortir un deuxième single, "BIG
            BIG Msd"
            cinq mois plus tard, en octobre 2024. Actuellement,
            MSD travaille sur une mixtape très attendue, bien que pour l'instant,
            aucune date de sortie n'ait été
      ...
      <div class="modal-layout">
        <div class="modal-info">
          ...
          <p class="description">
            ...
            lycée,
            ou encore Fortnite. Sorti le 17 novembre 2023, il commence enfin à mixer un peu sa voix.
          </p>
        </div>
      </div>
    </div>
